...
import { AgesLimit, GamesGenres, GamesPlatforms, GamesSortCriteria, SortTypes } from '../../types/gameCardTypes'
...
export const selectVisibleGamesCount = (state: RootStateType) => state.gamesPage.visibleGamesCount
