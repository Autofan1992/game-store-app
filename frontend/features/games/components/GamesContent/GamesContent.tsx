        ...
        <Container className='py-5'>
            ...
            <div className='row justify-content-center'>
                ...
                <div className='col-lg-9'>
                    <div data-testid='games-list' className='cards-row rounded-styled-block h-100'>
                        {games.length > 0 ? (
                            <div className='row g-3'>
                                {games.map((game) => {
                                    ...
                                    return (
                                        <div className='col-md-6 col-xl-4 text-black' key={game.id}>
                                            <GameItem
                                                {...game}
                            ...
                            <div className='h-100 d-flex justify-content-center align-items-center position-relative'>
                                {loading ? (
                                    ...
                                    <h2 data-testid='games-not-found-title' className='fw-bold'>
